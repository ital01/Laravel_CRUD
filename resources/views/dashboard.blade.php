                        ...
                        <div class="col-lg-12">
                            <div class="">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 container d-flex align-items-center justify-content-center">
                                        <div class="w-75">
                                            <h3>Editar cadastro pelo ID</h3>
                                            <form class="py-1" id="form-search-id">
                                                <div class="input-group">
                                                    <input type="number" id="search-ID" name="searchID"
                                                        class="form-control" placeholder="Busque o ID do cadastro"
                                                        min="1">
                                            ...
                                            <form id="form-atualizar" action="/dashboard/atualizar/{id}" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    <label for="nome" class="form-label fs-5">Nome</label>
                                                    <input name="nome" class="form-control" id="nome-editar"
                                                        value="">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="email" class="form-label fs-5">Email</label>
                                                    <input name="email" class="form-control" id="email-editar"
                                                        value="">
                                                </div>
                                                <button type="submit"
