...
-->
    ...
    <div class="fixed-top p-4 text-right">
        @auth
        <a href="{{ url('/dashboard') }}" class="font-weight-bold btn btn-outline-dark" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='#000'">Dashboard</a> 
        @else
        <a href="{{ route('login') }}" class="font-weight-bold btn btn-outline-dark" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='#000'">Log in</a>

        @if (Route::has('register'))
        <a href="{{ route('register') }}" class="ml-4 font-weight-bold btn btn-outline-dark" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='#000'">Register</a>
        @endif
        @endauth
    </div>
    @endif
